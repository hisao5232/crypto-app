...
export default function ChartCard({ title, description, height = "h-80", children }: ChartCardProps) {
  return (
    <div className="p-6 bg-card border border-border rounded-2xl shadow-xl flex flex-col">
      ...
      <div className={`${height} w-full rounded-xl overflow-hidden relative`}>
        {children ? (
          ...
          /* childrenがない場合はプレースホルダーを表示 */
          <div className="flex items-center justify-center h-full bg-neutral-900/50 border border-dashed border-border rounded-xl">
